...
export default function ItemJob(props) {
  ...
  return (
    <div
      className="px-3 py-3"
      onClick={() => navigate(`/detailJob/${listJob.id}`)}
    >
      <Card>
        <Card.Img
          role="button"
        ...
        <Card.Body>
          <div className="flex items-center">
            <img
              src={listJob.avatar}
              style={{ heigth: "30px", width: "30px", borderRadius: 50 }}
              alt=""
            />
