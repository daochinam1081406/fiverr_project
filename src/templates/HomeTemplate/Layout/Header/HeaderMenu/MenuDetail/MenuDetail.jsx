        ...
        <div className="content-carousel mt-8">
          <div className="top flex flex-row justify-between items-center">
            <h1 className="text-2xl text-gray-600">
              Most popular in {menuItem.tenLoaiCongViec}
            </h1>
            <div className="icon">
              <i
                class="fa-solid fa-circle-chevron-left mr-3"
                style={{ color: "#f5f5dc", fontSize: "25px" }}
              ></i>

              <i
                class="fa-solid fa-circle-chevron-right"
                style={{ color: "#9e9e9e", fontSize: "25px" }}
              ></i>
            </div>
          </div>
